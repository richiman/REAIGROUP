...
<li class="nav-item dropdown user-menu">
    ...
    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <?php if(config('adminlte.usermenu_image')): ?>
            <img src="imagenes/<?php echo e(Auth::user()->imagen); ?>"
                 class="user-image img-circle elevation-2"
                 alt="<?php echo e(Auth::user()->imagen); ?>">
        <?php endif; ?>
...
<?php /**PATH C:\Users\PC bre\Desktop\ReaiGroupLaravel\ReaiGroup\vendor\jeroennoten\laravel-adminlte\src/../resources/views/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>