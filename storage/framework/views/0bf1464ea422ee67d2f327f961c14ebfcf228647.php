...
<div class="container  ">
  <div class="container card bg-dark ">
    ...
    <h4>Inversion total: <?php echo e("$ " . number_format($porcProyecto, 0, ",", ",")); ?>.00</h4>
    <br>
  </div>
   ...
   var ctx = document.getElementById('barChart2').getContext('2d');
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?php echo e($disponibleTepic); ?>,<?php echo e($porcProyecto); ?>,],
            backgroundColor: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HONOR\Desktop\Proyectos web\Laravel\ReaiGroupLaravel\ReaiGroup\resources\views/layouts/desarrollos/invertirBarloTepic.blade.php ENDPATH**/ ?>